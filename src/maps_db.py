...
class MapsDB():
    ...
    def __init__(self, osu_path: str):
        if MapsDB.__maps_db_obj_cache is not None:
            return
    ...
    def __check_maps_table(self) -> bool:
    ...
    def __check_meta_table(self) -> bool:
    ...
    def __update_maps_db(self):
        ...
        data = OsuDbReader.get_beatmap_md5_paths(f'{self.__osu_path}/osu!.db')
    ...
    def get_map_file_name(self, map_md5: str, filepath: bool = True) -> str | None:
